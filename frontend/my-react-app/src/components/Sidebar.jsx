...
// - Shows "Roadmap History" list (live from Firestore) — clicking an item
//   loads that saved roadmap back into the Dashboard.
        ...
        <aside className="w-64 h-screen sticky top-0 flex flex-col glass-light border-r border-gray-100/80 flex-shrink-0">
            ...
            <div className="flex-1 overflow-y-auto p-4">
                <div className="flex items-center gap-1.5 mb-3 px-1">
                    ...
                    <p className="text-xs font-bold text-highlight-dark uppercase tracking-wider">Roadmap History</p>
                </div>

                {!user && (
                    <p className="text-xs text-muted px-1">Login to see your saved roadmaps.</p>
                )}
                    ...
                    {roadmaps.map((rm) => (
                        ...
                        >
                            <div className="min-w-0">
                                ...
                                <p className="text-[10px] text-muted truncate">{rm.topic}</p>
                            </div>
